...
class Equipment(BaseComponent):
    ...
    def __init__(self, weapon: Optional[Item] = None, armor: Optional[Item] = None, hat: Optional[Item] = None,):
        self.weapon = weapon
        self.armor = armor
        self.hat = hat
    ...
    def item_is_equipped(self, item: Item) -> bool:
        return self.weapon == item or self.armor == item or self.hat == item
